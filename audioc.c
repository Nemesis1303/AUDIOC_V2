...
struct sockaddr_in remToRecvSAddr_RTCP; // Multicast address RTCP (port RTP+1)
...
{   
    ...
    {
        int result;
        result = sendto(socketDesc, bye_packet_send, (sizeof(rtcp_t) ) , 0 , (struct sockaddr *) &remToSendSAddr, sizeof(remToSendSAddr));
    ...
    {   
        ...
        {  
            ...
            if (FD_ISSET(socketDesc, &readSet) == 1) 
            {
                ...
                else if (dataReceived == (sizeof(rtcp_t)))
                {
